...
module.exports = function (app) {
    ...
    app.post('/v1/api/tweet', sharestorieservice().uploadFile(), testimonialController.sendTweet)
    ...
    app.post('/v1/api/share-on-linkedin', sharestorieservice().uploadFile(), testimonialController.sendTextMessageToLinkedIn)
